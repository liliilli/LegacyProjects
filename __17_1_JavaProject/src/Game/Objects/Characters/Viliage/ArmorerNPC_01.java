...
public class ArmorerNPC_01 extends AbstractNPCObject {
    public ArmorerNPC_01(int x, int y, String name, MapInfoContainer c) {
        super(x, y, c);
        mName = name;
    }
            ...
            case FOCUS_LOGPANEL:
                if (!isTalked) {
                    ...
                    switch (localSwitch.getSwitchStatus()) {
                        ...
                        /* 의견에 의하면 HardWired 방식 대신에
                        런타임 클래스 호출 및 명명법을 쓰라고 하는 듯. */
                        case "0000":
                            displayLog(
                                    this.getName() + ": " + "Welcome to My armory.");
                            displayLog("What can I do for you?");
                            displayLog(" <Buy Weapon (B) / Quit (Q)>");
                        ...
                        case "1100":
                            ...
                            break;
                        case "1110":
                            displayLog("You have already bought my iron sword.");
                            localSwitch.setSwitches("0001");
                            returnTalking();
                            break;
                        case "0100":
