...
import static Screen.PanelHandler.PanelList.PLAY_SCR;
import static Screen.PanelHandler.PanelList.PLAY_STATUS;

public class _TestScene extends AbstractScene {
    private boolean flag = false;

    public _TestScene(String path) throws IOException, FontFormatException {
        super(path);
